...
import type { PlatformUsageData } from "../../views/utils/formatData";
interface IProps {
  children?: ReactNode;
...
const PlatformUsage: FC<IProps> = ({ data }) => {
  // console.log(data, data);
  const { platforms, count, percentage, avg_play_time, total_play_time } = data;
        ...
        series: [
          {
            ...
            type: "pie",
            radius: "50%",
            data: platforms.map((name: any, i: any) => ({
              value: data[i],
              name,
            })),
          },
